...
<head>
    ...
    <!-- ==========================
    	Title 
    =========================== -->
    <title>KHAERUL UMAM</title>
    
    <!-- ==========================
    	Favicons 
    =========================== -->
    <link rel="shortcut icon" href="icons/favicon.html">
	<link rel="apple-touch-icon" href="icons/apple-touch-icon.html">
...
<body id="page-top">
    ...
    <header>
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <img src="image/umam.png" class="navbar-logo pull-left" alt="" />
                    <a href="" class="navbar-brand animated flipInX">KHAEL</a>
                </div>
        ...
        <div class="jumbotron">
            <img src="image/umam.png" class="img-responsive scrollpoint sp-effect3" alt="" />	
            <div class="social-wrapper">
                <ul class="brands brands-inline hidden-xs scrollpoint sp-effect1">
                    <li><a href="https://www.facebook.com/umam6690/"><i class="fa fa-facebook  hi-icon-effect-8"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                </ul>   
                <h2 class="scrollpoint sp-effect3">KHAERUL UMAM</h2>
        ...
        <a href="#contact" class="btn btn-reference btn-lg btn-active scroll scrollpoint sp-effect2" role="button"><i class="fa fa-bolt"></i> Hire me</a> 
        </div>
    </header>
    <!-- ==========================
    	HEADER - END 
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-2 hidden-xs scrollpoint sp-effect1"><!-- Profile image --> 
                	<img src="image/umam.png" class="image-bordered img-responsive" alt="" />                
                </div><!-- Profile end --> 
                
                <div class="col-md-7 col-sm-6 scrollpoint sp-effect1"><!-- Profile description --> 
                	<h3>KHAERUL UMAM</h3>
                  	<p>Lulusan S1 Teknik Informatika STMIK Indonesia Mandiri Bandung Jawa Barat. Kelahiran tahun 1999 di Brebes Jawa Tengah, Tinggal di Kota Cirebon Jawa Barat. Hobi membaca, olahraga sepak bola, menonton film, dan bermain game.</p>      
                                              ...
                                              <div class="carousel-inner">
                                               <!-- Slideshow item 1 active --> 
                                                  <div class="item active">
                                                        <p>All About Me in http://khaerulumam.my.id</p> 
                                                  </div>
                                               <!-- Slideshow item 2 -->    
                                                  <div class="item">
                                                        <p> </p>
                  ...
                  <div class="timeline">
			         ...
			         <div class="event">
                          <div class="event-info">
                      	  ...
                      	  <span>SDN Pengampon 2 Cirebon</span>
                      </div> <!-- BLOG POST 1 - END -->
                ...
                <div class="row"><!-- Toogle my skills start --> 
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul>
                                    <li>Installasi Jaringan Local Area Network, Oprating System : Windows dan Linux</li>
                                    <li>Installasi Setup Software berbasis Windows dan Linux</li>
                                    <li>Memahami konsep dalam merancang sebuah sistem informasi yang berbasis komputer PC dan
Internet</li>
                                    <li>Mampu membuat Database : MySQL dan Ms. Access</li>
                                    <li>Mengoperasikan CorelDraw dan Photoshop</li>
                                    <li>Mengoperasikan Microsoft Office : Ms. Word, Ms. Excel dan Ms. PowerPoint</li>
                                    <li>Mampu manajemen file folder dengan baik dan rapih
                                    </li>
                                    <li>Mampu membuat Website dan Maintenance Website</li>
                                    <li>Mampu mendesign sebuah Website dengan Bootstrap</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                         ...
                         <div class="card-body">
                             <ul>
                                 <li>Mampu membuat surat proposal bisnis baik dalam bahasa Indonesia maupun dalam bahasa Inggris
serta mampu mengadministrasikannya</li>
                                <li>Mampu menggunakan bahasa Inggris secara lisan dan tulisan dengan aktif</li>
                                <li>Memiliki Jiwa Enterpreneur</li>
                             </ul>
                         </div>   
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="macbook-inner black">
                    	<div class="row scrollpoint sp-effect4">
                            ...
                            <img src="image/umam.png" class="contact-image image-responsive hidden-xs hidden-sm" alt="" />
                            	<div class="contact-info">
                                	<p>Khaerul Umam</p>
                                    <p>Kejawanan, Kota Cirebon</p>
                                    <p>Whatsapp: </p>
                                    <p>IG: </p>
                                </div>
                            </div>
